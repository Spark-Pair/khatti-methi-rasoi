  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center gap-12">
        ...
        {/* Brand Text Staggered */}
        <div className="overflow-hidden flex flex-col items-center">
          <motion.h2 
            initial={{ y: 40 }}
            animate={{ y: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="text-white font-serif text-2xl uppercase tracking-[0.4em] font-black"
          >
            Khatti Methi
          </motion.h2>
          <motion.p 
            ...
            className="text-[#FDCD07] text-[10px] uppercase tracking-[0.6em] font-bold mt-2"
          >
            Imperial Dining
          </motion.p>
        </div>
